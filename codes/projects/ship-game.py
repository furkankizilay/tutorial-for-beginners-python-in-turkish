...
print("-"*35)
print("Amiral battı oyununa hoigeldiniz.")
print("-"*35)
print("Puanınız : ",puan)
print("-"*35)
print_board(board)
...
while True :
    if (gemi_satir == gemi1_satir and gemi_sutun == gemi1_sutun) :
        ...
        gemi2_sutun = rand(board)
        continue
    elif (gemi1_satir == gemi2_satir and gemi_sutun == gemi2_sutun) :
        gemi2_satir = rand(board)
        gemi2_sutun = rand(board)
        continue
    else :
        ...
        tahmin_sutun = int(input("Sutun giriniz : "))

        if ((tahmin_satir == gemi_satir and tahmin_sutun == gemi_sutun) or (tahmin_satir == gemi1_satir and tahmin_sutun == gemi1_sutun) or (tahmin_satir == gemi2_satir and tahmin_sutun == gemi2_sutun)) :
